...
if (isset($_GET['settings-updated']) && of_get_option('default_avatar') != '') {
	...
	if (!is_wp_error($image)) {
		...
		update_option('pinclone_avatar_96', $upload_dir['baseurl'] . '/avatar-96x96.' . $ext);
		$image->resize(48, 48, true);
		$image->save($upload_dir['basedir'] . '/avatar-48x48.' . $ext);
		update_option('pinclone_avatar_48', $upload_dir['baseurl'] . '/avatar-48x48.' . $ext);
	}
} else if (isset($_GET['settings-updated']) && of_get_option('default_avatar') == '') {
	$ext = explode('.', get_option('pinclone_avatar_48'));
	$ext = array_pop($ext);
	$upload_dir = wp_upload_dir();

	delete_option('pinclone_avatar_48');
	delete_option('pinclone_avatar_96');
...
function optionsframework_options() {
	...
	$options[] = array(
		'desc' => __(' Over Last X Days', 'options_framework_theme'),
	...
	$options[] = array(
		...
		'desc' => __('Header background image. Preffered dimensions 40px height max.'),
		'id' => 'header',
		'type' => 'upload');
	...
	$options[] = array(
		...
		'desc' => __('Leave blank to hide top header message', 'options_framework_theme'),
		'id' => 'top_message',
	...
	$options[] = array(
		...
		'desc' => __('If enabled, users can use &lt;strong> &lt;em> &lt;a> &lt;blockquote> html code in description field.', 'options_framework_theme'),
		'id' => 'htmltags',
		'std' => 'disable',
		'type' => 'radio',
		'options' => array('enable' => __('Enable', 'options_framework_theme'), 'disable' => __('Disable', 'options_framework_theme')));
	...
	*/
	...
	$options[] = array(
		...
		'desc' => __('reCAPTCHA Public Key', 'options_framework_theme'),
		'id' => 'captcha_public',
		'std' => '',
		'type' => 'text');
		
	$options[] = array(
		'desc' => __('reCAPTCHA Private Key', 'options_framework_theme'),
		'id' => 'captcha_private',
		'std' => '',
		'type' => 'text');

	$options[] = array(
		'desc' => __('Sign up for the keys at <a href="http://www.google.com/recaptcha/whyrecaptcha">Google reCAPTCHA</a>. Leave blank to hide captcha.', 'options_framework_theme'),
		'type' => 'info');
	...
	$options[] = array(
		...
		'desc' => __('If you purchase the optional Browser Extension Pack, enter the ID to activate (<a href="http://ericulous.com/2013/09/18/browser-addonsextensions-pack-for-pinclone-pro/" target="_blank">how to get ID</a>).', 'options_framework_theme'),
	...
	*/
	...
	$options[] = array(
		...
		'desc' => __('Recommended Width: 520px or lower. HTML / PHP / Javascript allowed. Note: Javascript based ads like adsense may not appear in the lightbox, only in single posts.', 'options_framework_theme'),
	...
	$options[] = array(
		'desc' => __('Recommended Width: 250px or lower. HTML / PHP / Javascript allowed.', 'options_framework_theme'),
...
<li><a href="http://wordpress.org/plugins/wp-postratings/" target="_blank">WP-Postratings</a> (allow ratings and microformats)</li>
		<ul>
		...
		- Edit Others User Profile (frontend)
		</p>
		...
		<li>
		WP-Admin > Users > All Users<br />If you delete a user, you can "Delete all posts" but not "Attribute all posts to XYZ".
		</li>
		</ol>
		
		<br><br>Always <b>Read our <a href="http://www.pinclone.net/clients/knowledgebase.php" target="_blank">Knowledge Base</a> or <a href="http://www.pinclone.net/clients/submitticket.php" target="_blank"> Open a Support Ticket</a> for any questions that you might have.</b>
		</li>
